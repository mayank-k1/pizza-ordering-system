...
public class ReportController {
	...
	@RequestMapping(value="/FetchRecordsWithinBillRange", method=RequestMethod.GET)
	public ModelAndView getOrderDetails(@ModelAttribute("billRangeObj")BillRangeBean billRangeBean) throws Exception{
		ModelAndView modelAndView = new ModelAndView();
		List<PizzaOrderBean> beanList = pizzaService.getOrderDetails(billRangeBean.getFromPrice(), billRangeBean.getToPrice());
		modelAndView.setViewName("OrderReport");
		modelAndView.addObject("list", beanList);
		return modelAndView;
	}
	...
	*/
	...
	public ModelAndView handleNoRecordFoundException(Exception exception){
		ModelAndView modelAndView = new ModelAndView();
