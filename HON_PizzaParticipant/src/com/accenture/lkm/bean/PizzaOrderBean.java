...
public class PizzaOrderBean {
	...
	@NotEmpty @Size(min=3, max=30, message="name must contain 3 to 30 char")
	private String customerName;	
	
	@Size(min=10, max=10, message="number should contain at leat 10")
	private String contactNumber;	
	
	private Double bill;
	
	@NotNull(message="number of pieces is a mandator") @Range(min=1)
